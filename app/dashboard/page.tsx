...
export default function Dashboard() {
  ...
  return (
    <>
      ...
      <div className="h-screen flex bg-[#0B0D10] text-white overflow-hidden">
        {/* Sidebar */}
        <aside className="w-1/5 p-6 border-r shadow-md overflow-y-auto bg-[#0B0D10] text-white">
        ...
        {/* Content */}
        {/* <main className="w-4/5 p-8 bg-gradient-to-br from-gray-100 to-gray-200 overflow-y-auto"> */}
        <main className="w-4/5 p-8 bg-[#0B0D10] overflow-y-auto">
          <div className="flex flex-wrap items-center justify-between gap-4 mb-6">
            ...
            <Button
              // variant="outline"
              // variant="ghost"
              className="shadow-m bg-indigo-700 hover:bg-indigo-600"
              ...
              <div className="grid gap-4 ">
                {catNotes.map((note) => (
                  <Card
                    ...
                    className="hover:shadow-xl transition rounded-2xl border border-gray-200 bg-gradient-to-br from-gray-50 to-gray-100"
                  >
                    <CardContent className="p-6 space-y-3 ">
                      ...
                      <div className="flex items-center gap-4 mt-3">
                        <Button
                          variant="link"
                          className="p-0 text-indigo-400 font-medium"
                          onClick={(e) => {
                            e.stopPropagation();
                            setExpanded(
                              expanded === note._id ? null : note._id
                            );
                          }}
                        >
                          {expanded === note._id
